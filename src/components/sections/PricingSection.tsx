          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <div className="card-feature shadow-card animate-slide-up hover-scale">
              <div className="text-center">
                ...
                <div className="text-4xl font-black text-gradient mb-2">{settings.trial_hours} Horas</div>
                <p className="text-muted-foreground mb-6">Teste sem risco: {settings.trial_hours} horas grátis para conhecer o serviço</p>
            ...
            <div className="card-premium shadow-elegant relative animate-scale-in stagger-1 transform scale-105 border-primary/50 hover-scale">
              ...
              <div className="text-center pt-6">
                ...
                <div className="mb-6">
                  <div className="text-5xl font-black text-gradient mb-2">R$ {settings.monthly_price}</div>
                ...
                <button className="btn-hero w-full mb-4 flex items-center justify-center gap-2" onClick={() => openWhatsApp(`Olá! Quero ativar o plano Mensal (R$ ${settings.monthly_price}/mês).`)}>
                  <BadgeCheck className="w-5 h-5" />
                  Assinar Mensal
                </button>
                <button className="btn-whatsapp w-full flex items-center justify-center gap-2" onClick={() => openWhatsApp(`Olá! Quero ativar o plano Mensal (R$ ${settings.monthly_price}/mês).`)}>
            ...
            <div className="card-feature shadow-card animate-slide-up hover-scale relative">
              ...
              <div className="text-center">
                ...
                <div className="text-4xl font-black text-gradient-trimestral mb-2 opacity-60">R$ {settings.quarterly_price}</div>
                <p className="text-muted-foreground mb-6">R$ {(parseFloat(settings.quarterly_price) / 3).toFixed(2)}/mês • cobrado a cada 3 meses</p>
            ...
            <div className="card-feature shadow-card animate-slide-up stagger-1 hover-scale relative">
              ...
              <div className="text-center">
                ...
                <div className="text-4xl font-black text-gradient-warning mb-2 opacity-60">R$ {settings.annual_price}</div>
                <p className="text-muted-foreground mb-6">R$ {(parseFloat(settings.annual_price) / 12).toFixed(2)}/mês • cobrado anualmente</p>
